...
from data_non_linear import *
np.random.seed(1234)
 
parser = argparse.ArgumentParser()
parser.add_argument('--save_dir' , default = 'Experiment_non_linear')
...
dataset = gauss_tl_non_linear(n_task, n, p, p_s, p_conf, eps ,g, lambd, lambd_test)
